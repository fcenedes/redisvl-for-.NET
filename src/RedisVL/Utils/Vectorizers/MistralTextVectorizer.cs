...
/// <summary>
/// Text vectorizer using Mistral AI's embedding API.
/// </summary>
public class MistralTextVectorizer : BaseTextVectorizer
{
    private const string DefaultApiUrl = "https://api.mistral.ai/v1/embeddings";
    private const string DefaultModel = "mistral-embed";
    private readonly string _apiKey;
    private readonly string _apiUrl;
    
    /// <summary>
    /// Creates a Mistral AI text vectorizer.
    /// </summary>
    /// <param name="model">Model name (default: mistral-embed).</param>
    /// <param name="apiKey">API key (defaults to MISTRAL_API_KEY env var).</param>
    /// <param name="apiUrl">Custom API endpoint URL.</param>
    /// <param name="dims">Embedding dimensions (0 = model default).</param>
    /// <param name="httpClient">Optional HttpClient instance.</param>
    public MistralTextVectorizer(
    ...
    {
        Model = model;
        _apiKey = apiKey ?? GetRequiredEnvVar("MISTRAL_API_KEY");
        _apiUrl = apiUrl;
        Dims = dims;
